package org.ggyool.apigatewayservice.config;

import org.ggyool.apigatewayservice.filter.CustomFilter;
...
public class FilterConfig {
    ...
    @Bean
    public RouteLocator gatewayRoutes(RouteLocatorBuilder routeLocatorBuilder, CustomFilter customFilter) {
